...
export function SignUser() {
    const tableHead = ['Details', 'Father Name', 'Mother Name', 'Email', 'Address', 'Phone', 'Date', 'Action']
                                        ...
                                        {users
                                            ...
                                            .filter((val) => {
                                                if (val === '') {
                                                    ...
                                                    val.father_name.toLowerCase().includes(value.toLowerCase()) ||
                                                    val.mother_name.toLowerCase().includes(value.toLowerCase()) ||
